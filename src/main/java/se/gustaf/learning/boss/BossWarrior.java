...
import se.gustaf.learning.boss.skill.BlockAttackBossSkill;
...
public class BossWarrior extends Boss {
	public BossWarrior() {
		...
		setHealth(5.0);
		setEquipment(buildWarriorArmor(
		...
		addPotionEffect(PotionEffectType.REGENERATION, 2);
		
		setPassenger(EntityType.CAVE_SPIDER);
		
		addSkille(new BlockAttackBossSkill());
	}
